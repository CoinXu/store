...
var Collection = (function () {
    ...
    Collection.prototype.remove = function (keyOrMod) {
        ...
        var primaryKey = utils_1.isObject(keyOrMod) ? keyOrMod[this.primaryKey] : keyOrMod;
        var PrimaryKey = this.primaryKey;
        this.models = this.models.filter(function (m) { return notPrimaryKey ? m !== keyOrMod : m[PrimaryKey] !== keyOrMod; });
    ...
    Collection.prototype.update = function (primaryValue, props) {
        ...
        this.models = this.models.map(function (m) { return m[_this.primaryKey] === primaryValue ? __assign({}, m, props) : m; });
    ...
    Collection.prototype.find = function (filter) {
        ...
        return compatible_1.find(this.models, function (mod) { return compatible_1.every(FilterKeys, function (k) { return filter[k] === mod[k]; }); }) || null;
    };
