...
var Store = function () {
  ...
  function Store() {
    ...
    this.mw = [];
    this.state = (0, _extends3.default)({}, state);
  ...
  (0, _createClass3.default)(Store, [{
    ...
    key: '_dispose',
    value: function _dispose(action, callback) {
      var _this = this;
      ...
      (0, _compose2.default)(this.mw)(action, this.state, function (result) {
        return Object.assign(_this.state, result);
      }, function () {
    ...
    value: function single(action, callback) {
      ...
      return this._dispose(action, function (state) {
        _this2.scheduler.push(function () {
          _this2.observer(state);
    ...
    value: function multiple(actions, callback) {
      ...
      var list = actions.map(function (action) {
        return function (a, b, next) {
          return _this3._dispose(action, function () {
            return next();
          });
        };
      });
      (0, _compose2.default)(list)(null, null, _utils.noop, function () {
        _this3.scheduler.push(function () {
          _this3.observer(_this3.state);
          if ((0, _utils.isFunction)(callback)) callback(_this3.state);
        });
      });
      return this;
    }
